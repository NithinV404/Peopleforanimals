   <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <p style="color: white">PFA ADMIN</p>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="manage-donations.php" aria-expanded="true"><i class="ti-folder"></i><span>Donation Details</span></a>
                            </li>

                            <li>
                                <a href="manage-volunteer.php" aria-expanded="true"><i class="ti-folder"></i><span>Volunteer Details</span></a>
                            </li>
